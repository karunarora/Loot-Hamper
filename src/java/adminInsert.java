 ...
 * @author Karun
 */
@WebServlet(urlPatterns = {"/adminInsert"})
public class adminInsert extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet adminInsert</title>");            
            out.println("</head>");
            out.println("<body>");
            Connection con=null;
        Statement stmt=null;
        ...
        response.sendRedirect("adminPanel.jsp");
            ...
            out.println("<h1>Servlet adminInsert at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(adminInsert.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

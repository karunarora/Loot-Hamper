...
<body class="cbp-spmenu-push">
    ...
    <script  src="js/admin/index2.js"></script>
   ...
   <script src="js/admin/bootstrap.js"> </script>
	...
	<script type="text/javascript" src="js/admin/jquery.jqcandlestick.min.js"></script>
	<link rel="stylesheet" type="text/css" href="css/admin/jqcandlestick.css" />
	<!-- //candlestick --><!-- //for points and multiple y-axis charts js -->

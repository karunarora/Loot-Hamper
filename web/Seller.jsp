...
<div class="container">
		...
		<div class="login">
                    <form action="SellerInsert" method="post" enctype="multipart/form-data>
			...
			<div class="login-mail">
				...
				<div class="login-mail">
					...
					<i class="glyphicon glyphicon-map-marker"></i>
                                ...
                                <input type="hidden"  name="sname" value="<%=str1%>">	
				...
				<label class="hvr-skew-backward" >
					<input style="color: black" type="submit" value="Add Product">
				</label>
